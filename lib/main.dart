...
import 'package:clock_view/components/clock_view.dart';
import 'package:clock_view/ui/colors.dart';
import 'package:clock_view/utils/time.dart';
            ...
            children: [
              TimerBuilder.periodic(
                ...
                builder: (context) {
                  ...
                  // String hour = DateFormat.jm().format(DateTime.now()).hour < 10
                  //     ? "0${DateTime.now().hour}"
